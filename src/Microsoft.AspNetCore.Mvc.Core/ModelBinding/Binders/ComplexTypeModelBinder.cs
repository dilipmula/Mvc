...
namespace Microsoft.AspNetCore.Mvc.ModelBinding.Binders
{
    ...
    public class ComplexTypeModelBinder : IModelBinder
    {
        ...
        protected virtual bool CanBindProperty(ModelBindingContext bindingContext, ModelMetadata propertyMetadata)
        {
            ...
            if (!CanUpdatePropertyInternal(propertyMetadata, logger))
            {
                return false;
            }
        ...
        // Internal for tests
        internal static bool CanUpdatePropertyInternal(ModelMetadata propertyMetadata, ILogger logger)
        {
            return !propertyMetadata.IsReadOnly || CanUpdateReadOnlyProperty(propertyMetadata, logger);
        }

        private static bool CanUpdateReadOnlyProperty(ModelMetadata propertyMetadata, ILogger logger)
        {
            var propertyType = propertyMetadata.ModelType;

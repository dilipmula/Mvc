...
namespace Microsoft.AspNetCore.Mvc.ModelBinding.Binders
{
    ...
    public class HeaderModelBinder : IModelBinder
    {
        ...
        public Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            {
                logger.LogWarning($"Could not bind to model as the model with type {bindingContext.ModelType} is an unsupported type. The supported types are 'string' and array of 'string'.");
